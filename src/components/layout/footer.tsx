        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
          <div className="flex flex-col col-span-1 md:col-span-2">
            ...
            <p className="text-primary-foreground/80 max-w-sm">
                Advocates, Commissioners For Oaths & Notaries Public. A premier law firm in Mombasa committed to excellence and justice.
            </p>
          </div>
          <div>
          ...
          <div>
             <h3 className="text-lg font-headline font-semibold text-accent mb-4">Connect With Us</h3>
              <p className="text-primary-foreground/80">info@kanyij-advocates.co.ke</p>
