...
const stats = [
  ...
  { value: 'Top 10', label: 'Law Firms', icon: <Badge className="h-10 w-10 text-accent" /> },
];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-1">
        <section className="relative h-48 flex items-center justify-center text-center bg-primary/10">
        ...
        <section className="pb-16 sm:pb-24 bg-secondary">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
              {stats.map((stat) => (
                <Card key={stat.label} className="text-center p-6 shadow-lg">
        ...
        <section className="py-16 sm:py-24 bg-background">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="row align-items-center grid md:grid-cols-2 gap-12">
              ...
              <div className="about-text">
                <div className="section-title">
                  ...
                  <h2 className="text-3xl sm:text-4xl font-headline font-bold tracking-tight text-primary mt-2">
                    We Are Top Lawyers With<span> 37 Years</span> Of Experience
                  </h2>
                  <p className="mt-4 text-muted-foreground">
                ...
                <div className="mt-8">
                  <Link href="/#contact" className="inline-block bg-primary text-primary-foreground hover:bg-primary/90 px-6 py-3 rounded-md font-semibold">
                    Learn More
                  </Link>
                </div>
              </div>
